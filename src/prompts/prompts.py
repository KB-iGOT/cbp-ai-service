...
# Curriculum coverage analysis (src/api/v1/coverage_analysis.py) is deterministic, not
# LLM-driven: Behavioral/Functional use an exact theme/sub-theme tag match, Domain uses
# embedding cosine similarity against a fixed threshold. No prompt is needed for either.